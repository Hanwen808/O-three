...
int main() {
    ...
    for (auto iter = d_vt.begin(); iter != d_vt.end(); iter ++) {
        ...
        string outputFilePath = "../Params/d_mawi/o3skt2_32KB_" + std::to_string(*iter) + "_";
        saveResults(outputFilePath, skt, realFlowInfo, 2331, res_throughput, res_response_time);
    }
